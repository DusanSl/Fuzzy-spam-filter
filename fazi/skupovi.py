...
linkovi_minimalni = fuzz.trapmf(x_broj_linkova, [0, 0, 0, 1])
linkovi_umereni   = fuzz.trimf (x_broj_linkova, [0, 1, 3])
linkovi_brojni    = fuzz.trapmf(x_broj_linkova, [2, 4, 10, 10])
