...
kljucne_retke    = fuzz.trapmf(x_kljucne_reci, [0,  0,  2,  5])
kljucne_umerene  = fuzz.trimf (x_kljucne_reci, [3,  7, 12])
kljucne_ucestale = fuzz.trapmf(x_kljucne_reci, [10, 14, 20, 20])

linkovi_oskudni   = fuzz.trapmf(x_broj_linkova, [0,  0,  1,  3])
linkovi_umereni   = fuzz.trimf (x_broj_linkova, [2,  5,  9])
linkovi_preobilni = fuzz.trapmf(x_broj_linkova, [8, 12, 20, 20])
